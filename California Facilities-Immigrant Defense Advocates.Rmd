...
# Summary of Transfers Made and Recieved
...
library(kableExtra)
kable(sent, col.names = c("Facility Name", "Total People Transferred Out from April to October 2020"))%>%
...
kable(recieve, col.names = c("Facility Name", "Total People Recieved in Transfers from April to October 2020"))%>%
    kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
